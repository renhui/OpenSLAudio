...
extern "C"
JNIEXPORT void JNICALL
Java_com_renhui_openslaudio_MainActivity_playAudioByOpenSL_1pcm(JNIEnv *env, jobject instance,
                                                                 jstring pamPath_) {
    release();
...
extern "C"
JNIEXPORT void JNICALL
Java_com_renhui_openslaudio_MainActivity_sendPcmData(JNIEnv *env, jobject instance,
